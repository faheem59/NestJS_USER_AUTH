...
@Module({
  imports: [TypeOrmModule.forFeature([User, RoleEntity, Permission, RefreshToken]),],
  providers: [UserRepository, PermissionRepository, UserService, ClientService, MailService],
