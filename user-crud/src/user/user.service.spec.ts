...
describe('UserService', () => {
  ...
  describe('create', () => {
    it('should create a new user and return it', async () => {
      ...
      jest.spyOn(userRepository, 'creatUser').mockResolvedValue(mockUser as unknown as User);
    ...
    it('should throw an InternalServerErrorException if creatUser fails', async () => {
      ...
      jest.spyOn(userRepository, 'creatUser').mockRejectedValue(new Error('Error'));

      await expect(authService.create(mockUser)).rejects.toThrow(InternalServerErrorException);
    });
  });
  ...
  describe('findById', () => {
    it('should find and return user by ID', async () => {
      jest.spyOn(userRepository, 'findById').mockResolvedValue(mockUser as unknown as User);
  ...
  describe('update', () => {
    it('should update a user and return it', async () => {
      ...
      jest.spyOn(userRepository, 'updateOne').mockResolvedValue({ ...mockUser, ...updateUserDto } as unknown as User);
  ...
  describe('remove', () => {
    ...
    it('should throw an InternalServerErrorException if remove fails', async () => {
      jest.spyOn(userRepository, 'findById').mockResolvedValue(mockUser as unknown as User);
      jest.spyOn(userRepository, 'destroy').mockRejectedValue(new Error('Error'));
