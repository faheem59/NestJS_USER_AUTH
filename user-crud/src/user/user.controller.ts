import { Controller, Post, Body, Get, Param, Delete, Patch, HttpException, HttpStatus, Query } from '@nestjs/common';
...
export class UserController {
    ...
    @Patch(':id')
    async update(@Param('id') id: number, @Body() updateUserDto: UpdateUserDto, @CurrentUser() user: User): Promise<UpdateUserResponse> {
        if (user.id !== id) {
    ...
    async addPermissions(@Param('id') userId: number, @Body() addPermissionsData: AddPermissionsDto) {
    ...
    async removePermissions(@Param('id') userId: number, @Body() removePermissionsData: RemovePermissionsDto) {
