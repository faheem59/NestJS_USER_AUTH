...
export class CourseRepository {
    constructor(
        ...
        @InjectRepository(Lecture) private readonly lectureRepositroy: Repository<Lecture>,
    ...
    async addLectures(courseId: number, lectureData: LectureDto): Promise<Lecture> {
